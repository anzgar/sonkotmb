...
class Text extends API
{
    ...
    public function api_get($id_slug)
    {
        ...
        return LIVE_EDIT ? API::liveEdit($text['nko'], Url::to(['/admin/text/a/edit/', 'id' => $text['text_id']])) : $text['nko'];
    }
    ...
    private function notFound($id_slug)
    {
        ...
        if(!Yii::$app->user->isGuest && preg_match(TextModel::$SLUG_PATTERN, $id_slug)){
            $text = Html::a(Yii::t('easyii/nko/api', 'Create text'), ['/admin/text/a/create', 'slug' => $id_slug], ['target' => '_blank']);
        }
